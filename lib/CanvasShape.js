...
function CanvasShape(shapeObj) {
	var CS = this;
	CanvasElement.apply(CS, [shapeObj, shapeObj.type]);
...
CanvasShape.prototype = Object.create(CanvasElement.prototype);
...
/* ------------------------------------------------
	...
	*/
CanvasShape.prototype._setDrawArgs = function(shapeObj) {
	var CS = this;
	...
	CS.transformOrigin = _params.transformOrigin || shapeObj.params.transformOrigin || shapeObj.transformOrigin || (CS._type === 'rect' ? '0 0' : '50% 50%');
}

CanvasShape.prototype.draw = function(translation, isArc) {
	var CS = this;

	if (CS.strokeDashSize > 0 && CS.strokeDashGap > 0) CS.stage.ctx.setLineDash([CS.strokeDashSize * CS.stage.qualityScale, CS.strokeDashGap * CS.stage.qualityScale]);
