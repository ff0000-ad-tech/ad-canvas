...
*/
var CanvasTweener = new function() {
	var CT = this
	...
	*/
	...
	/**
		...
		(end)
	*/
	CT.init = function(target) {
		var _ctBase = new CanvasTweenerBase()
		_ctBase.init(target.stage || target)
	}
}()

function CanvasTweenerBase() {}

CanvasTweenerBase.prototype = {
