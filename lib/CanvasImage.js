		...
		*/
		...
		class CanvasImage extends CanvasElement {
			constructor(imgObj) {
				...
				CI.sourceW = _params.sourceW || _imgSourceWidth || CI.width * _imageScale
				CI.sourceH = _params.sourceH || _imgSourceHeight || CI.height * _imageScale
