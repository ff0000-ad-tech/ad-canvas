/**
	...
	@desc
		Apply various color effects to a canvas given a Canvas element or CanvasDrawer instance.
		<br><br>
		All examples in this class demonstrate effects applied to this image:<br>
		<img src="../docs_images/canvasdrawer/default.jpg" /><br>

*/
var CanvasColoring = new function() {
	var self = this;
	...
	*/
	...
	function _engine(obj) {
		...
		if (obj.color) {
			...
			if (obj.color.r === undefined) throw new Error("The color passed to CanvasColorUtils does not meet the HEX or RGB/A definition requirement: given '" + obj.color + "'");
		}
		//
		...
		var _imageData = CanvasUtils.getImageData(_target);
