...
function CanvasCircle(circObj) {
	circObj.type = 'arc';
	CanvasShape.apply(this, arguments);
}


CanvasCircle.prototype = Object.create(CanvasShape.prototype);
CanvasCircle.prototype.constructor = CanvasCircle;

CanvasCircle.prototype._setShapeParams = function(args) {
	var CC = this;
	CC.x = args[0];
	CC.y = args[1];
...
CanvasCircle.prototype._prepDrawing = function(translation) {
	var CC = this;
	if (translation) {
