...
function CanvasRect(rectObj) {
	rectObj.type = 'rect';
	CanvasShape.apply(this, arguments);
}

CanvasRect.prototype = Object.create(CanvasShape.prototype);
CanvasRect.prototype.constructor = CanvasRect;

CanvasRect.prototype._setShapeParams = function(args) {
	var CR = this;
	CR.x = args[0];
	CR.y = args[1];
	CR.width = args[2];
...
CanvasRect.prototype._prepDrawing = function(translation) {
	var CR = this;
	if (translation) {
