 ...
 * 		<br>
 * 		<img src="https://github.com/ff0000-ad-tech/ad-docs/blob/master/assets/ad-canvas/lineCap.jpg" />
 * 		<br>
 ...
 * 		<br>
 * 		<img src="https://github.com/ff0000-ad-tech/ad-docs/blob/master/assets/ad-canvas/lineJoin.jpg" />
 * 		<br>
	...
	_wrapText(translation, draw) {
		...
		if (_recalc) {
			...
			CT.deltaProps.strokeOffset =
				(CT.strokePosition === 'outer' || CT.strokePosition === 'center' ? CT.strokeWidth / 4 : 0) *
				CT.stage.qualityScale

			CT.drawProps.offsetX =
				/*CT._marginLeft + */ (CT.alignText === 'right' ? -1 : 1) * CT.deltaProps.strokeOffset
