 ...
 * @class CanvasSprite
 * @desc
 * Uses a {@link CanvasDrawer}'s {@link CanvasImage} to create either a traditional sprite animation or a sprite-atlas animation (using JSON data for positioning and sizing).<br>
 * <codeblock>
